...
function Designer() {
  ...
  useDndMonitor({
    onDragEnd: (event: DragEndEvent) => {
      ...
      // this if check will drop sidebar element over the designer drop area
    ...
    >
      ...
      {mouseIsOver && (
        <>
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-pluse">
